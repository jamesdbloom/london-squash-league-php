...
<form action='<?php echo Link::root . Link::Login_Url; ?>' method='post'>
    ...
    <div class="login_form">
        <p>
            ...
            <input id='email' type='email' name='email' value="<?php echo Form::escape_and_sanitize_field_value(Cookies::get_cookie_value(Cookies::REMEMBER_ME_COOKIE_NAME)); ?>" size='35' autocorrect=”off” autocapitalize=”off” autocomplete=”off”
                   required='required'
        ...
        <p>
            ...
            <input id='password' type='password' name='password' value='' autocorrect=”off” autocapitalize=”off” autocomplete=”off” required='required' tabindex='10'/>
        </p>
