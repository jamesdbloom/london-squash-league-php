...
if (Session::is_administrator()) {
    ...
    Page::header(Link::Users_Admin, array(), '', '', array(Link::get_link(Link::User_Admin_Recreate_Tables)));
    ...
    print_create_form_start(Link::root . Link::User_Admin_Create_Controller_Url, 'user');
    ...
    print_create_form_start(Link::root . Link::User_Admin_Create_Controller_Url, 'session');
    ...
    print "<form method='post' action='" . Link::root . Link::User_Admin_Delete_Controller_Url . "'><div class='delete_sessions_form'>";
