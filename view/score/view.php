    ...
    if (!empty($match_id)) {
        ...
        if ($leagueData->user_is_player_in_match($user->id, $match_id)) {
            ...
            if (!$GLOBALS['errors']->has_errors()) {
                ...
                print "<input type='hidden' name='" . Urls::redirect_to . "' value='" . Parameters::read_header('HTTP_REFERER', Link::root . Link::View_League_Url) . "'/>";
            ...
            Headers::set_redirect_header(Link::root . Link::View_League_Url . '?message=only_match_players');

        }

    } else {
        Headers::set_redirect_header(Link::root . Link::View_League_Url . '?message=no_match_selected');
    }
