...
class RankingDAO extends DAO implements Mapper
{
    ...
    public static function get_all_by_League($league_id)
    {
        $query =
"SELECT
...
WHERE ROUND.START <= NOW() AND ROUND.END >= NOW() AND M.SCORE IS NOT NULL AND LEAGUE.LEAGUE_ID = :" . self::league_id_column . ")
UNION ALL
(SELECT
P1.PLAYER_ID as P1_ID,
U1.EMAIL as P1_EMAIL,
...
WHERE ROUND.START <= NOW() AND ROUND.END >= NOW() AND M.SCORE IS NOT NULL AND LEAGUE.LEAGUE_ID = :" . self::league_id_column . ")) as RANKING
