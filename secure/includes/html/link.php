...
class Link
{
    ...
    const Recreate_Table = "Recreate Table";
    ...
    public static function get_link($link_name, $fully_qualified = false, $text = '')
    {
        if (count(self::$links) <= 0) {
            ...
            self::$links[self::Recreate_Table] = new Link('recreate_schema_controller.php', self::Recreate_Table, true);
            ...
            self::$links[self::View_League] = new Link(self::View_League_Url, self::View_League, true);
        }
