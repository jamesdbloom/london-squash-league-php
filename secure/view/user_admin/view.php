...
if (Session::is_administrator()) {
    ...
    print "<tr><th class='name'>Name</th><th class='email hide_on_very_small_screen'>Email</th><th class='mobile_privacy hide_on_small_screen'>Mobile Privacy</th><th class='mobile'>Mobile</th><th class='button last'></th></tr>";
    foreach ($userData->user_list as $user) {
        print_form(
            array('name', 'email hide_on_very_small_screen', 'mobile_privacy hide_on_small_screen', 'mobile'), array($user->name, $user->email, User::get_mobile_privacy_text($user->mobile_privacy), "<a href='tel:$user->mobile'>$user->mobile<a/>"),
    ...
    print "<td class='mobile_privacy last hide_on_small_screen'><select name='mobile_privacy'>";
